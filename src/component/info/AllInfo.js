...
function AllInfo() {
  return (
    <>
            <div className="info">
                <img src="https://www.foodiesfeed.com/wp-content/uploads/2023/10/mediterranean-chickpea-salad.jpg" alt="" />
                <div className="para"><p>Chickpea-Salad</p></div>
            </div>
            <div className="info">
      ...
      <div className="info">
        <img src="https://media.istockphoto.com/id/1514290382/photo/td-supreme-pizza.jpg?b=1&s=612x612&w=0&k=20&c=NoMQil0NA8vnXYycSeAPmRhJpUDQx5GB9-2G_e1RISU=" alt="" />
        <div className="para"><p>Supreme-Pizza</p></div>
      </div>
          <div className="info">
        <img src="https://media.istockphoto.com/id/1414650948/photo/french-fries-in-a-white-paper-box-isolated-on-white.jpg?s=612x612&w=0&k=20&c=BlWArpBXURqcrof7Sdhck_X6czCVs7pJZYd-XtX8-JA=" alt="" />
        <div className="para"><p>Fries</p></div>
      </div>
      <div className="info">
    ...
    <div className="para"><p>Silver-Pancakes</p></div>
      ...
      <div className="info">
        ...
        <div className="para"><p>Soda-water</p></div>
      </div>
      <div className="info">
        <img src="https://media.istockphoto.com/id/1283225821/photo/grand-slam-breakfast-with-pancakes-bacon-eggs-and-toast.jpg?b=1&s=612x612&w=0&k=20&c=D854MFyUh-tXadApeGp652Z21Xknp9PM8lVbrFTXmLw=" alt="" />
        <div className="para"><p>Pancakes</p></div>
      </div>
      <div className="info">
      ...
      <div className="info">
        <img src="https://media.istockphoto.com/id/163348480/photo/french-fries-in-a-paper-wrapper.jpg?s=612x612&w=0&k=20&c=qpw_ZY_sv_FTNxMmCyxZLqDbS7czq1n9rUUVFl_oZ_c=" alt="" />
        <div className="para"><p>Fries</p></div>
      </div>
      <div className="info">
